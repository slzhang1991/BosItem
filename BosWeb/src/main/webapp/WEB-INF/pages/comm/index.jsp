...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#btnEp").click(function() {
			// 进行表单校验
			var res = $("#editPasswordForm").form("validate");
			// 校验通过
			if (res) {
				// 手动校验两次密码是否一致
	...
	<div data-options="region:'center'">
		<div id="tabs" fit="true" class="easyui-tabs" border="false">
			<div title="消息中心" id="subWarp" style="width:100%;height:100%;overflow:hidden">
				<iframe src="${pageContext.request.contextPath }/page_comm_home" style="width:100%;height:100%;border:0;"></iframe>
				<%--这里显示公告栏、预警信息和代办事宜--%>
			</div>
		</div>
	</div>
            ...
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
	            <form id="editPasswordForm">
	                <table cellpadding=3>
	                    <tr>
	                        <td>新密码：</td>
	                        <td><input id="newPwd" type="Password" class="txt01 easyui-validatebox" data-options="validType: 'length[4, 10]'" required="true" /></td>
	                    </tr>
	                    <tr>
	                        <td>确认密码：</td>
	                        <td><input id="repeatPwd" type="Password" class="txt01 easyui-validatebox" data-options="validType: 'length[4, 10]'" required="true" /></td>
	                    </tr>
	                </table>
	            </form>
            </div>
