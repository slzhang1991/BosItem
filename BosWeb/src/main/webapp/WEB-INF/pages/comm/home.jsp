...
<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath }/js/easyui/ext/portal.css">
...
<script type="text/javascript">
	$(function() {
		panels = [ {
			...
			height : 255,
			collapsible : true,
			href : 'page_portal_gonggao'
		}, {
			id : 'p2',
			title : '代办事宜',
			height : 255,
			collapsible : true,
			href : 'page_portal_daiban'
		}, {
			id : 'p3',
			title : '预警信息',
			height : 255,
			collapsible : true,
			href : 'page_portal_yujing'
		}, {
			id : 'p4',
			title : '系统BUG反馈',
			height : 255,
			collapsible : true,
			href : 'page_portal_bug'
		} ];
